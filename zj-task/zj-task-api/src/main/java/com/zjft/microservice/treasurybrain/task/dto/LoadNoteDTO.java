...
public class LoadNoteDTO extends DTO {
	...
	@ApiModelProperty(value = "清点人员")
	private String opNo;

	@ApiModelProperty(value = "清点人员名称")
	...
	@ApiModelProperty(value = "容器配钞信息(现用)")
	private List<TaskEntityDTO> taskEntityDTOList;

	@ApiModelProperty(value = "清点钞箱编号")
	private List<String> cassetteNoList;
